...
const socialCommand: CommandHandler = (_args, config) => ({
  lines: [
    ...
    createLine('output', ''),
    createLine('link', `  Email:     ${config.social.email}`, `mailto:${config.social.email}`),
    createLine('link', `  GitHub:    github.com/${config.social.github}`, `https://github.com/${config.social.github}`),
    createLine('link', `  Twitter:   x.com/${config.social.twitter}`, `https://x.com/${config.social.twitter}`),
    createLine('link', `  YouTube:   youtube.com/@${config.social.youtube}`, `https://youtube.com/@${config.social.youtube}`),
    createLine('link', `  Instagram: instagram.com/${config.social.instagram}`, `https://instagram.com/${config.social.instagram}`),
    createLine('link', `  LinkedIn:  linkedin.com/in/${config.social.linkedin}`, `https://linkedin.com/in/${config.social.linkedin}`),
    createLine('output', ''),
  ],
});
